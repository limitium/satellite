<div class="hfeed" id="primarycontent">
    ...
    <div class="comments">
        ...
        <div class="metalinks">
            ...
            <span class="trackbacklink"><a title="Copy this URI to trackback this entry." href="http://bestblog.wordpress.com/2007/06/13/elle-effect/trackback/">Trackback Address</a></span>		</div>
        <hr />
    ...
    <div id="respond" class="js">
        <h3 id="reply-title">Leave a Reply <small><a style="display: none;" href="/2007/06/13/elle-effect/#respond" id="cancel-comment-reply-link" rel="nofollow">Cancel reply</a></small></h3>
        <form id="commentform" method="post" action="http://bestblog.wordpress.com/wp-comments-post.php">

            <input type="hidden" value="wordpress" id="hc_post_as" name="hc_post_as" />

            <div class="comment-form-field comment-textarea">
                <label for="comment">Enter your comment here...</label>
                <div id="comment-form-comment"><textarea style="overflow-y: hidden; position: absolute; top: 0px; left: -9999px; height: 145px; width: 478px; line-height: 16px; text-decoration: none; letter-spacing: normal;" tabindex="-1"></textarea><textarea name="comment" id="comment" style="overflow-y: hidden; height: 145px;"></textarea></div>
            </div>
            ...
            <div id="comment-form-identity">
                ...
                <div id="comment-form-nascar">
                    <ul>
                        <li>
                            <a class="social_buttons sb_24 sb_guest" id="postas-guest" href="#comment-form-guest">
                                <span>Guest</span>
                            </a>
                        </li>
                        <li class="selected">
                            <a class="social_buttons sb_24 sb_wordpress" id="postas-wordpress" href="#comment-form-wordpress">
                                <span>limiti…</span>
                            </a>
                        </li>
                        <li>
                            <a class="social_buttons sb_24 sb_twitter" id="postas-twitter" href="#comment-form-load-service:Twitter">
                                <span>Log In</span>
                            </a>
                        </li>
                        <li>
                            <a class="social_buttons sb_24 sb_facebook" id="postas-facebook" href="#comment-form-load-service:Facebook">
                                <span>Log In</span>
                            </a>
                        </li>
                    </ul>
                ...
                <div class="comment-form-service" id="comment-form-guest">
                    <div class="comment-form-padder">
                        <div class="comment-form-avatar">
                            <img width="25" class="no-grav" alt="Gravatar" src="http://www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25&amp;d=mm">
                        </div>

                        <div class="comment-form-fields">
                            <div class="comment-form-field comment-form-email">
                                <label for="email">Email <span class="required">(required)</span> <span class="nopublish">(Not published)</span></label>
                                <div class="comment-form-input"><input type="text" value="" name="email" id="email" /></div>
                            </div>
                            <div class="comment-form-field comment-form-author">
                                <label for="author">Name <span class="required">(required)</span></label>
                                <div class="comment-form-input"><input type="text" value="" name="author" id="author" /></div>
                            </div>
                            <div class="comment-form-field comment-form-url">
                                <label for="url">Website</label>
                                <div class="comment-form-input"><input type="text" value="" name="url" id="url" /></div>
                            </div> 
                        </div>
                ...
                <div class="comment-form-service selected" id="comment-form-wordpress">
                    <div class="comment-form-padder">
                        <div class="comment-form-avatar">
                            <img width="25" class="no-grav" alt="Gravatar" src="http://1.gravatar.com/avatar/9f8d47c162122566fd106460220f4240?s=25&amp;d=http%3A%2F%2Fs2.wp.com%2Fwp-content%2Fmu-plugins%2Fhighlander-comments%2Fimages%2Fwplogo.png&amp;r=G">
                        </div>

                        <div class="comment-form-fields">
                            <p class="comment-form-posting-as pa-wordpress"><strong>limitium</strong>: You are commenting using your WordPress.com account. <span class="comment-form-log-out">(&nbsp;<a href="http://bestblog.wordpress.com/wp-login.php?action=logout&amp;redirect_to=http%3A%2F%2Fbestblog.wordpress.com%2F2007%2F06%2F13%2Felle-effect%2F&amp;_wpnonce=5626026123" rel="nofollow">Log&nbsp;Out</a>&nbsp;)</span></p>
                        </div>
                ...
                <div class="comment-form-service" id="comment-form-twitter">
                    <div class="comment-form-padder">
                        <div class="comment-form-avatar">
                            <img width="25" class="no-grav" alt="Twitter picture" src="http://www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25&amp;d=mm">
                        </div>

                        <div class="comment-form-fields">
                            <input type="hidden" value="" class="comment-meta-twitter" id="twitter-avatar" name="twitter_avatar" />
                            <input type="hidden" value="" class="comment-meta-twitter" id="twitter-user_id" name="twitter_user_id" />
                            <input type="hidden" value="" class="comment-meta-twitter" id="twitter-access_token" name="twitter_access_token" />
                            <p class="comment-form-posting-as pa-twitter"><strong></strong> You are commenting using your Twitter account. <span class="comment-form-log-out">(&nbsp;<a href="javascript:HighlanderComments.doExternalLogout( 'twitter' );">Log&nbsp;Out</a>&nbsp;)</span></p>
                        </div>
                ...
                <div class="comment-form-service" id="comment-form-facebook">
                    <div class="comment-form-padder">
                        <div class="comment-form-avatar">
                            <img width="25" class="no-grav" alt="Facebook photo" src="http://www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25&amp;d=mm">
                        </div>

                        <div class="comment-form-fields">
                            <input type="hidden" value="" class="comment-meta-facebook" id="facebook-avatar" name="fb_avatar">
                            <input type="hidden" value="" class="comment-meta-facebook" id="facebook-user_id" name="fb_user_id">
                            <input type="hidden" value="" class="comment-meta-facebook" id="facebook-access_token" name="fb_access_token">
                            <p class="comment-form-posting-as pa-facebook"><strong></strong> You are commenting using your Facebook account. <span class="comment-form-log-out">(&nbsp;<a href="javascript:HighlanderComments.doExternalLogout( 'facebook' );">Log&nbsp;Out</a>&nbsp;)</span></p>
                        </div>
            ...
            <div id="comment-form-subscribe"> 
                <p class="comment-subscription-form"><input type="checkbox" tabindex="6" style="width: auto;" value="subscribe" id="subscribe" name="subscribe"> <label for="subscribe" id="subscribe-label" class="subscribe-label">Notify me of follow-up comments via email.</label></p><p class="comment-subscription-form"><input type="checkbox" tabindex="7" style="width: auto;" value="subscribe" id="subscribe_blog" name="subscribe_blog"> <label for="subscribe_blog" id="subscribe-blog-label" class="subscribe-label">Notify me of new posts via email.</label></p></div>
            ...
            <input type="hidden" value="1320738094" name="genseq" />
            <script id="hiab-script-1" type="text/javascript">
                jQuery( function( $ ) {
                    $( '#hiab-script-1' ).parents( 'form' ).append( '&lt;input type="hidden" name="hiab" value="1" /&gt;' );
                } );
            </script>
            <p style="display: none;"><input type="hidden" value="eff964dbb1" name="akismet_comment_nonce" id="akismet_comment_nonce" /></p><script src="http://s2.wp.com/wp-content/mu-plugins/akismet-2.5/form.js?m=1308783981g&amp;ver=1" type="text/javascript"></script>
            <p style="display: none;"><input type="hidden" value="1320741630552" name="ak_js" id="ak_js" /></p>					<input type="hidden" value="1" name="hiab" /></form>
    </div><!-- #respond -->
